...
(function (root) {
  ...
  const TISSUES = [
    ...
    { id: "haem", label: "Haematology — limited coverage", short: "Haem", color: "#B64545", values: ["Haematology", "Lymphoma", "Myeloma", "Leukaemia"], icon: "haem", description: "Limited pilot coverage only. The dedicated haematology library has not yet been developed.", limited: true },
  ...
  root.SACTCheckTissueUI = Object.freeze({ version: "0.48.0", tissues: TISSUES, refresh, select, contextualTumourLabel, tissueForGroups });
