...
## v0.17 conditional one-file protocol publishing
...
NCCP 00857 and NCCP 00588 use the generic JSON assessment pathway. NCCP 00209 Modified FOLFOX-6 and NCCP 00226 weekly paclitaxel remain in shadow-validation mode; their legacy assessments remain available pending consultant and oncology-pharmacy review.
