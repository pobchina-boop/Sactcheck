...
def supportive_registry() -> dict[str, Any]:
    return {
        ...
        "release": RELEASE,
        "source": {
            "status": "nccp_v6_risk_classification_with_national_nccp_antiemetic_guidance",
            "title": "NCCP Classification Document for SACT Induced Nausea and Vomiting, V6 (2025)",
            "url": NCCP_ANTIEMETIC_URL,
            "local_document_note": "User facing supportive care links use national NCCP antiemetic guidance.",
        ...
        "scripts": {
            "generic-high-cuh-v2-05-21": {
                "label": "NCCP antiemetic guidance for high emetogenic risk",
                "risk_level": "high",
                "url": "https://healthservice.hse.ie/documents/7180/Supportive_Care_Antiemetics_for_inclusion_NCIS_Medical_Oncology.pdf",
                "source_url": NCCP_ANTIEMETIC_URL,
                "status": "national_guidance_link",
                "summary": "Legacy compatible internal mapping retained for backward compatibility. User facing supportive care opens national NCCP antiemetic guidance.",
            ...
            "generic-moderate-cuh": {
                "label": "NCCP antiemetic guidance for moderate emetogenic risk",
                "risk_level": "moderate",
                "url": "https://healthservice.hse.ie/documents/7180/Supportive_Care_Antiemetics_for_inclusion_NCIS_Medical_Oncology.pdf",
                "source_url": NCCP_ANTIEMETIC_URL,
                "status": "national_guidance_link",
            ...
            "generic-low-cuh-v2-05-21": {
                "label": "NCCP antiemetic guidance for low emetogenic risk",
                "risk_level": "low",
                "url": "https://healthservice.hse.ie/documents/7180/Supportive_Care_Antiemetics_for_inclusion_NCIS_Medical_Oncology.pdf",
                "source_url": NCCP_ANTIEMETIC_URL,
                "status": "national_guidance_link",
            ...
            "docetaxel-cuh-v2": {
                ...
                "source_url": NCCP_ANTIEMETIC_URL,
                "status": "national_guidance_link",
                "summary": "Use national NCCP antiemetic guidance and confirm docetaxel specific steroid premedication against the current regimen protocol.",
