...
assert.ok(html.includes("SACTCheck v0.48.4 — oral anti-cancer service filter"));
assert.ok(html.includes("v0.48.4 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.48.4"));
