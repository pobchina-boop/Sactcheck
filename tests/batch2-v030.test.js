...
assert.ok(html.includes("SACTCheck v0.48.3 — ranked regimen search"));
assert.ok(html.includes("v0.48.3 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.48.3"));
