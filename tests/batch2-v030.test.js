...
assert.ok(html.includes("SACTCheck v0.56.0 — Clinical scenario interpreter and regimen information"));
assert.ok(html.includes("v0.56.0 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.56.0"));
