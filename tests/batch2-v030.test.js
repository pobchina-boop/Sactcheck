...
assert.ok(html.includes("SACTCheck v0.50.1 — Clinical Copy Refinement"));
assert.ok(html.includes("v0.50.1 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.50.1"));
