...
assert.ok(html.includes("SACTCheck v0.50.0 — Multiple Myeloma Core"));
assert.ok(html.includes("v0.50.0 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.50.0"));
