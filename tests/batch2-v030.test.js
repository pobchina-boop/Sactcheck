...
assert.ok(html.includes("SACTCheck v0.46.0 — complete Head and Neck library"));
assert.ok(html.includes("Version 0.46.0 · complete Head and Neck library"));
assert.ok(html.includes("js/protocol-loader.js?v=0.46.0"));
