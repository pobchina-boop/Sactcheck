...
assert.ok(html.includes("SACTCheck v0.45.1 — tissue-specific shared-regimen indications"));
assert.ok(html.includes("Version 0.45.1 · contextual shared-regimen indication hotfix"));
