...
assert.ok(html.includes("SACTCheck v0.49.0 — Haemato-Oncology Foundation"));
assert.ok(html.includes("v0.49.0 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.49.0"));
