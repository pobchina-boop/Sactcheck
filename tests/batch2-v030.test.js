...
assert.ok(html.includes("SACTCheck v0.56.1 — Five-Regimen Knowledge Base Pilot"));
assert.ok(html.includes("v0.56.1 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.56.1"));
