...
assert.ok(html.includes("SACTCheck v0.48.0 — feasibility study release"));
assert.ok(html.includes("v0.48.0 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.48.0"));
