...
assert.ok(html.includes("SACTCheck v0.43.0 — complete Gynaecology library"));
assert.ok(html.includes("Version 0.43.0 · complete Gynaecology library"));
assert.ok(html.includes("js/protocol-loader.js?v=0.43.0"));
