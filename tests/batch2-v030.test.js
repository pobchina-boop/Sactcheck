...
assert.ok(html.includes("SACTCheck v0.36.0 — Complete NCCP breast library"));
assert.ok(html.includes("Version 0.36.0 · Complete NCCP breast library"));
assert.ok(html.includes("js/protocol-loader.js?v=0.36.0"));
