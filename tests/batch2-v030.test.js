...
assert.ok(html.includes("SACTCheck v0.48.2 — CTCAE haematology education update"));
assert.ok(html.includes("v0.48.2 · What changed?"));
assert.ok(html.includes("js/protocol-loader.js?v=0.48.2"));
