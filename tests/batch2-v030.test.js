...
assert.ok(html.includes("SACTCheck v0.44.0 — complete Genitourinary library"));
assert.ok(html.includes("Version 0.44.0 · complete Genitourinary library"));
assert.ok(html.includes("js/protocol-loader.js?v=0.44.0"));
