...
assert.ok(html.includes("SACTCheck v0.42.0 — complete Neuro-oncology library"));
assert.ok(html.includes("Version 0.42.0 · complete Neuro-oncology library"));
assert.ok(html.includes("js/protocol-loader.js?v=0.42.0"));
