...
assert.ok(html.includes("SACTCheck v0.35.0 — Batch 7 breast expansion"));
assert.ok(html.includes("Version 0.35.0 · Batch 7 breast expansion"));
assert.ok(html.includes("js/protocol-loader.js?v=0.35.0"));
