...
assert.ok(html.includes("SACTCheck v0.38.2 — tumour-site metadata integrity hotfix"));
assert.ok(html.includes("Version 0.38.2 · tumour-site metadata integrity hotfix"));
assert.ok(html.includes("js/protocol-loader.js?v=0.38.2"));
