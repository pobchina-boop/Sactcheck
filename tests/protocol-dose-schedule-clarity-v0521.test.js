...
assert(DoseSchedule);
assert.strictEqual(DoseSchedule.version, '0.52.2');
...
console.log(`v0.52.1 clarity guarantees retained in v0.52.2: ${usefulCoverage} useful protocols, ${scheduleCoverage} complete schedules and ${doseLevelCoverage} genuine dose-level tables.`);
