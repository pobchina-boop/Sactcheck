...
assert(DoseSchedule);
assert.strictEqual(DoseSchedule.version, '0.52.1');
...
console.log(`v0.52.1 Dose & Schedule clarity tests passed: ${usefulCoverage} useful protocols, ${scheduleCoverage} complete schedules and ${doseLevelCoverage} genuine dose-level tables.`);
