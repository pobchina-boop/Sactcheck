...
assert(html.includes('v0.48.0 · What changed?'), 'v0.38.0 release badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.48.0'), 'v0.38.0 alias cache key is missing.');
