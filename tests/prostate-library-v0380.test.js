...
assert(html.includes('Version 0.45.0 · complete Skin and Melanoma library'), 'v0.38.0 release badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.45.0'), 'v0.38.0 alias cache key is missing.');
