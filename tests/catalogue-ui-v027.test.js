...
assert(html.includes("SACTCheck v0.27.2"));
assert(html.includes("Version 0.27.2 · Duplicate-card hotfixes"));
assert(html.includes("js/protocol-loader.js?v=0.27.2"));
assert(!html.includes("Version 0.17 · Conditional JSON assessments"));
assert(html.includes("Protocol publisher v0.27.2"));
assert(importer.includes('version: "0.27.2"'));
...
console.log("v0.27.2 catalogue UI tests passed.");
