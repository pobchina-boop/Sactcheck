...
assert(html.includes("SACTCheck v0.27.1"));
assert(html.includes("Version 0.27.1 · Duplicate-card hotfix"));
assert(html.includes("js/protocol-loader.js?v=0.27.1"));
assert(!html.includes("Version 0.17 · Conditional JSON assessments"));
assert(html.includes("Protocol publisher v0.27.1"));
assert(importer.includes('version: "0.27.1"'));
...
console.log("v0.27.1 catalogue UI tests passed.");
