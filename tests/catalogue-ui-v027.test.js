...
assert(html.includes("SACTCheck v0.28.0"));
assert(html.includes("Version 0.28.0 · Batch 4 expansion"));
assert(html.includes("js/protocol-loader.js?v=0.28.0"));
assert(!html.includes("Version 0.17 · Conditional JSON assessments"));
assert(html.includes("Protocol publisher v0.28.0"));
assert(importer.includes('version: "0.28.0"'));
...
console.log("v0.28.0 catalogue UI tests passed.");
