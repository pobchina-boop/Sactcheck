...
assert(html.includes("SACTCheck v0.29.0"));
assert(html.includes("Version 0.29.0 · Batch 3 gynaecology expansion"));
assert(html.includes("js/protocol-loader.js?v=0.29.0"));
assert(!html.includes("Version 0.17 · Conditional JSON assessments"));
assert(html.includes("Protocol publisher v0.29.0"));
assert(importer.includes('version: "0.29.0"'));
...
console.log("v0.29.0 catalogue UI tests passed.");
