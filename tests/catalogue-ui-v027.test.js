...
assert(html.includes("SACTCheck v0.30.0"));
assert(html.includes("Version 0.30.0 · Batch 2 lung expansion"));
assert(html.includes("js/protocol-loader.js?v=0.30.0"));
assert(!html.includes("Version 0.17 · Conditional JSON assessments"));
assert(html.includes("Protocol publisher v0.30.0"));
assert(importer.includes('version: "0.30.0"'));
