...
assert(html.includes("SACTCheck v0.36.0"));
assert(html.includes("Version 0.36.0 · Complete NCCP breast library"));
assert(html.includes("js/protocol-loader.js?v=0.36.0"));
