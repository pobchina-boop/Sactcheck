...
assert(html.includes("SACTCheck v0.48.2"));
assert(html.includes("v0.48.2 · What changed?"));
assert(html.includes("js/protocol-loader.js?v=0.48.2"));
...
assert(loader.includes("Official NCCP source · Clinically validated"));
assert(loader.includes("Source link requires verification"));
