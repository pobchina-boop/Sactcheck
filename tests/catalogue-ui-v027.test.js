...
assert(html.includes("SACTCheck v0.27"));
assert(html.includes("Version 0.27 · ICI safety and treatment context"));
assert(html.includes("js/protocol-loader.js?v=0.27.0"));
assert(!html.includes("Version 0.17 · Conditional JSON assessments"));
assert(html.includes("Protocol publisher v0.27"));
assert(importer.includes('version: "0.27.0"'));
...
console.log("v0.27 catalogue UI tests passed.");
