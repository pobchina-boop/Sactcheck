...
assert(index.includes("v0.48.2 · What changed?"));
assert(index.includes("css/assessment-output.css?v=0.48.2"));
assert(index.includes("js/assessment-output.js?v=0.48.2"));
