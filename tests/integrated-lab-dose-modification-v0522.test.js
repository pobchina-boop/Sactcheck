...
assert.strictEqual(Dose.version, '0.52.4');
...
].forEach(text => assert(uiSource.includes(text), `Missing v0.52.4 interface marker: ${text}`));
...
console.log('v0.52.4 integrated laboratory and protocol dose-modification tests passed.');
