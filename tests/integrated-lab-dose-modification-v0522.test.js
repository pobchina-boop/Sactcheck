...
].forEach(text => assert(uiSource.includes(text), `Missing v0.55.0 interface marker: ${text}`));
...
console.log('v0.55.0 integrated laboratory and protocol dose-modification tests passed.');
