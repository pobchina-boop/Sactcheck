...
assert.strictEqual(Dose.version, '0.52.2');
assert(html.includes('SACTCheck v0.52.2 — Integrated Laboratory &amp; Dose Modification'));
assert(html.includes('js/protocol-dose-schedule.js?v=0.52.2'));
assert(html.includes('js/generic-assessment-ui.js?v=0.52.2'));
...
].forEach(text => assert(uiSource.includes(text), `Missing v0.52.2 interface marker: ${text}`));
...
console.log('v0.52.2 integrated laboratory and protocol dose-modification tests passed.');
