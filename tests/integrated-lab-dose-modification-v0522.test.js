...
assert.strictEqual(Dose.version, '0.52.3');
...
].forEach(text => assert(uiSource.includes(text), `Missing v0.52.3 interface marker: ${text}`));
...
console.log('v0.52.3 integrated laboratory and protocol dose-modification tests passed.');
