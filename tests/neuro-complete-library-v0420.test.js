...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');assert(html.includes('Version 0.45.2 · one-page clinical output and safety-language update'));assert(html.includes('js/protocol-loader.js?v=0.45.1'));assert(html.includes('js/drug-aliases.js?v=0.45.1'));
