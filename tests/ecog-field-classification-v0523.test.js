...
assert(html.includes('v0.52.5 · What changed?'));
...
assert.strictEqual(Classification.version, '0.52.5');
...
console.log(`v0.52.5 input-classification and ECOG tests passed across ${scanned} input definitions; ${protectedCount} ECOG/reproductive fields protected from laboratory classification.`);
