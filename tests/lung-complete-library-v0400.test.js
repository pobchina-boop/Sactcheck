...
assert(html.includes('v0.56.1 · What changed?'),'current release badge missing.');
assert(html.includes('js/protocol-loader.js?v=0.56.1'),'current loader cache key missing.');
