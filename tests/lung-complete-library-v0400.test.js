...
assert(html.includes('v0.48.3 · What changed?'),'current release badge missing.');
assert(html.includes('js/protocol-loader.js?v=0.48.3'),'current loader cache key missing.');
assert(html.includes('js/drug-aliases.js?v=0.48.3'),'current alias cache key missing.');
