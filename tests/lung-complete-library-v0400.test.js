...
assert(html.includes('v0.50.0 · What changed?'),'current release badge missing.');
assert(html.includes('js/protocol-loader.js?v=0.50.0'),'current loader cache key missing.');
