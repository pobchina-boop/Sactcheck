...
for(const {data} of sarcoma){
 ...
 assert(['0.41.0','0.43.0','0.44.0','0.45.0','0.45.1','0.46.0','0.47.0'].includes(m.sactcheck_encoding_version),`${code} lacks a supported Sarcoma/Gynaecology reconciliation encoding marker.`);
...
assert(html.includes('Version 0.47.0 · complete Neuroendocrine and adult tumour-agnostic libraries'),'v0.41.1 release badge missing.');
assert(html.includes('js/protocol-loader.js?v=0.47.0'),'v0.41.1 loader cache key missing.');
assert(html.includes('js/drug-aliases.js?v=0.47.0'),'v0.41.1 alias cache key missing.');
