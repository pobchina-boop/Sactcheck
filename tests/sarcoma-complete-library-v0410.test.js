...
assert(html.includes('v0.56.0 · What changed?'),'v0.41.1 release badge missing.');
assert(html.includes('js/protocol-loader.js?v=0.56.0'),'v0.41.1 loader cache key missing.');
