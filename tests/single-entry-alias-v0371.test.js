...
assert(html.includes('Version 0.42.0 · complete Neuro-oncology library'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.42.0'), 'Alias registry is not loaded with the current cache key.');
