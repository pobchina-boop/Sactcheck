...
assert(html.includes('Version 0.41.0 · complete sarcoma library'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.41.0'), 'Alias registry is not loaded with the current cache key.');
