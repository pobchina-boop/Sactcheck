...
assert(html.includes('Version 0.46.0 · complete Head and Neck library'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.46.0'), 'Alias registry is not loaded with the current cache key.');
