...
assert(html.includes('v0.48.3 · What changed?'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.48.3'), 'Alias registry is not loaded with the current cache key.');
