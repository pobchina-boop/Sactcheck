...
assert(html.includes('Version 0.45.2 · one-page clinical output and safety-language update'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.45.1'), 'Alias registry is not loaded with the current cache key.');
