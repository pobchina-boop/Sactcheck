...
assert(html.includes('Version 0.47.0 · complete Neuroendocrine and adult tumour-agnostic libraries'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.47.0'), 'Alias registry is not loaded with the current cache key.');
