...
assert(html.includes('v0.48.2 · What changed?'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.48.2'), 'Alias registry is not loaded with the current cache key.');
