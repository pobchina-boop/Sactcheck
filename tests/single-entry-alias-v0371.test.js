...
assert(html.includes('Version 0.39.0 · complete gastrointestinal library'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.39.0'), 'Alias registry is not loaded with the current cache key.');
