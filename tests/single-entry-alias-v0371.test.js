...
assert(html.includes('Version 0.45.0 · complete Skin and Melanoma library'), 'v0.38.0 badge is missing.');
assert(html.includes('js/drug-aliases.js?v=0.45.0'), 'Alias registry is not loaded with the current cache key.');
