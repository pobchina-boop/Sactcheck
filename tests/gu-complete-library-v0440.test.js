...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');assert(html.includes('v0.53.0 · What changed?'));assert(html.includes('js/protocol-loader.js?v=0.51.0'));
