...
assert(html.includes('v0.48.0 · What changed?'), 'v0.39.0 release badge is missing.');
assert(html.includes('js/protocol-loader.js?v=0.48.0'), 'v0.39.0 cache key is missing.');
assert(html.includes('js/drug-aliases.js?v=0.48.0'), 'v0.39.0 alias cache key is missing.');
