...
assert(html.includes('v0.50.1 · What changed?'), 'v0.39.0 release badge is missing.');
assert(html.includes('js/protocol-loader.js?v=0.50.1'), 'v0.39.0 cache key is missing.');
