...
assert.equal(pkg.version, APP_RELEASE, 'package.json version is not v0.53.0.');
assert(html.includes('<title>SACTCheck v0.53.0 — Immunotherapy Visual Safety</title>'), 'Current release title is missing.');
assert(html.includes('<span class="header-version">v0.53.0</span>'), 'Current header version is missing.');
assert(html.includes('v0.53.0 · What changed?'), 'Current release summary is missing.');
