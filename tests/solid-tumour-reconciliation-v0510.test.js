...
assert(inputCount >= 5895, `Solid Tumour input count regressed unexpectedly: ${inputCount}.`);
assert(ruleCount >= 5615, `Solid Tumour rule count regressed unexpectedly: ${ruleCount}.`);
