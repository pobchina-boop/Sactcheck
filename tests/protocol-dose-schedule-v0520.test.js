...
assert(html.includes('<title>SACTCheck v0.55.0 — Global Clinical Scenario Interpreter</title>'));
assert(html.includes('<span class="header-version">v0.55.0</span>'));
assert(html.includes('css/protocol-dose-schedule.css?v=0.55.0'));
assert(html.includes('js/protocol-dose-schedule.js?v=0.55.0'));
assert(html.indexOf('js/protocol-dose-schedule.js?v=0.55.0') < html.indexOf('js/generic-assessment-ui.js?v=0.55.0'));
