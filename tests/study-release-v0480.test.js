...
assert(index.includes('css/study-release-v0480.css?v=0.48.1'));
assert(index.includes('js/study-release.js?v=0.48.1'));
...
assert(studyJs.includes('const VERSION = "0.48.1"'));
