...
assert.strictEqual(pkg.version, "0.48.0");
assert.strictEqual(protocolIndex.protocol_count, 361);
assert(index.includes("SACTCheck v0.48.0 — feasibility study release"));
...
assert(index.includes('css/study-release-v0480.css?v=0.48.0'));
assert(index.includes('js/study-release.js?v=0.48.0'));
...
assert(studyJs.includes('const VERSION = "0.48.0"'));
