...
assert.strictEqual(Tissue.version, '0.45.1');
...
assert(html.includes('Version 0.45.3 · direct clinical PDF generation'));
assert(html.includes('js/tissue-ui.js?v=0.45.1'));
assert(html.includes('js/drug-aliases.js?v=0.45.1'));
