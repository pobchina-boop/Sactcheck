...
assert(html.includes('Version 0.44.0 · complete Genitourinary library'));
assert(html.includes('js/tissue-ui.js?v=0.44.0'));
assert(html.includes('js/drug-aliases.js?v=0.44.0'));
