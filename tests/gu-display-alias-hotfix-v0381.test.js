...
assert(html.includes('Version 0.40.0 · complete lung library'));
assert(html.includes('js/tissue-ui.js?v=0.40.0'));
assert(html.includes('js/drug-aliases.js?v=0.40.0'));
