...
assert(index.includes('v0.50.2 · What changed?'), 'Compact release summary is missing');
...
assert(index.includes('js/library-ux.js?v=0.50.2'), 'Library usability module is not loaded');
