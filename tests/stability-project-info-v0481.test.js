...
assert.strictEqual(pkg.version, "0.48.3");
assert(index.includes("SACTCheck v0.48.3 — ranked regimen search"));
assert(index.includes('css/stability-v0481.css?v=0.48.3'));
...
assert(loader.includes('version: "0.48.3"'));
assert(exists("RELEASE_NOTES_v0.48.3.md"));
assert(exists("GITHUB_COMMIT_v0.48.3.txt"));

console.log("v0.48.3 stability tests passed: protocol loading is concurrency-limited, transient errors retry safely and the opening page explains the project.");
