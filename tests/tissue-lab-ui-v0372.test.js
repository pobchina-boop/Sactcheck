...
assert(html.includes('Version 0.37.2 · Tissue UI + automatic ULN'));
assert(html.includes('id="tissueTypeGrid"'));
assert(html.includes('id="tissueLandingPanel"'));
assert(html.includes('js/local-lab-profile.js?v=0.37.2'));
assert(html.includes('js/tissue-ui.js?v=0.37.2'));
