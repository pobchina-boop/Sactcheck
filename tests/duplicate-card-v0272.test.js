...
assert(html.includes("js/protocol-loader.js?v=0.29.0"), "The loader cache key must be updated for the hotfix.");

console.log("v0.29.0 durvalumab duplicate-card regression tests passed.");
