...
assert(html.includes('v0.56.0 · What changed?'), 'Release badge is stale.');
assert(html.includes('js/protocol-loader.js?v=0.56.0'), 'Protocol loader cache key is stale.');
