...
assert(html.includes('v0.48.4 · What changed?'), 'Release badge is stale.');
assert(html.includes('js/protocol-loader.js?v=0.48.4'), 'Protocol loader cache key is stale.');
