...
assert(html.includes('Version 0.37.0 · Platform standardisation'), 'Release badge is stale.');
assert(html.includes('js/protocol-loader.js?v=0.37.0'), 'Protocol loader cache key is stale.');
