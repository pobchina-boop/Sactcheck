...
assert(html.includes('v0.50.1 · What changed?'), 'Release badge is stale.');
assert(html.includes('js/protocol-loader.js?v=0.50.1'), 'Protocol loader cache key is stale.');
