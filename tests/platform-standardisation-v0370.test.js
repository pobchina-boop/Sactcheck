...
assert(html.includes('v0.48.1 · What changed?'), 'Release badge is stale.');
assert(html.includes('js/protocol-loader.js?v=0.48.1'), 'Protocol loader cache key is stale.');
