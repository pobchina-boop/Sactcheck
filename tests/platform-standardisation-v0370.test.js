...
assert(html.includes('v0.48.3 · What changed?'), 'Release badge is stale.');
assert(html.includes('js/protocol-loader.js?v=0.48.3'), 'Protocol loader cache key is stale.');
