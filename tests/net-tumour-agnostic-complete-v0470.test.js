...
const html=fs.readFileSync(path.join(root,'index.html'),'utf8');assert(html.includes('v0.56.0 · What changed?'));assert(html.includes('js/tissue-ui.js?v=0.51.0'));assert(html.includes('js/protocol-context.js?v=0.48.4'));
